...
def build_model(input_dim: int, output_dim: int) -> Sequential:
    model = Sequential()
    model.add(Dense(512, input_shape=(input_dim, ), use_bias=False, activation='sigmoid', name="linear_1"))
    model.add(Dense(output_dim, input_shape=(512, ), use_bias=False, name="linear_2"))
